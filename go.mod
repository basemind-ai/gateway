module github.com/basemind-ai/monorepo
...
replace (
	github.com/basemind-ai/monorepo/cloud-functions/emailsender => ./cloud-functions/emailsender
	github.com/basemind-ai/monorepo/e2e => ./e2e
)
