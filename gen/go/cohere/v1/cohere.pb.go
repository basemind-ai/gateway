...
type CohereModelParameters struct {
	...
	K *float32 `protobuf:"fixed32,2,opt,name=k,proto3,oneof" json:"k,omitempty"`
...
func (x *CohereModelParameters) GetK() float32 {
	if x != nil && x.K != nil {
		return *x.K
	}
	return 0
...
var file_cohere_v1_cohere_proto_rawDesc = []byte{
	...
	0x65, 0x88, 0x01, 0x01, 0x12, 0x11, 0x0a, 0x01, 0x6b, 0x18, 0x02, 0x20, 0x01, 0x28, 0x02, 0x48,
	...
	0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x73, 0x22, 0x41, 0x0a, 0x14, 0x43, 0x6f, 0x68, 0x65,
