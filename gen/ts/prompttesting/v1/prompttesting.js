...
class PromptTestRequest$Type extends MessageType {
    constructor() {
        super("prompttesting.v1.PromptTestRequest", [
...
class PromptTestingStreamingPromptResponse$Type extends MessageType {
    constructor() {
        super("prompttesting.v1.PromptTestingStreamingPromptResponse", [
 ...
 */
export const PromptTestingService = new ServiceType("prompttesting.v1.PromptTestingService", [
